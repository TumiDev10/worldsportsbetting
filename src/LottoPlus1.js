    ...
    return(
        <div class="lotto__cont">
            <div class="page-headings">
                ...
                <span style={{position: 'absolute', marginLeft: '30px'}}>Lotto Plus 1 - Results</span>
            </div>
            
            <div class="lotto-results-cont">
              <div class="lotto-results-header-cont">
                <div class="lotto-results-header">LOTTO PLUS 1 RESULTS</div>
            ...
            <div class="lotto-results-winning-numbers">
                ...
                <div class="lotto-results-winners">
                    ...
                    <div class="lotto-results-winners-row background-grey">
                        ...
                        <div class="width-full">
                            <span class="text-color-pink">36</span>
                            <br></br>
                            FIVE CORRECT NUMBERS
                        </div>
                        <div class="width-full">R4,959.60</div>
                    </div>

                    <div class="lotto-results-winners-row">
                        <div class="width-full">DIV 4</div>
                        <div class="width-full">
                            <span class="text-color-pink">102</span>
                            <br></br>
                            FOUR CORRECT NUMBERS + BONUS BALL
                        </div>
                        <div class="width-full">R2,056.90</div>
                    </div>

                    <div class="lotto-results-winners-row background-grey">
                        <div class="width-full">DIV 5</div>
                        <div class="width-full">
                            <span class="text-color-pink">1933</span>
                            <br></br>
                            FOUR CORRECT NUMBERS
                        </div>
                        <div class="width-full">R191.90</div>
                    </div>

                    <div class="lotto-results-winners-row">
                        <div class="width-full">DIV 6</div>
                        <div class="width-full">
                            <span class="text-color-pink">2862</span>
                            <br></br>
                            THREE CORRECT NUMBERS + BONUS BALL
                        </div>
                        <div class="width-full">R129.60</div>
                    </div>

                    <div class="lotto-results-winners-row background-grey">
                        <div class="width-full">DIV 7</div>
                        <div class="width-full">
                            <span class="text-color-pink">38373</span>
                            <br></br>
                    ...
                    <div class="lotto-results-winners-row">
                        ...
                        <div class="width-full">
                            <span class="text-color-pink">30968</span>
                            <br></br>
